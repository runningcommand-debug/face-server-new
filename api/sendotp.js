...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const message = `${otp} is your OTP for Gumshuda & Mila website. Valid for 5 minutes. Do not share.`;
    ...
    if (result.return === true) {
      ...
      res.status(400).json({ success: false, message: result.message || 'Failed to send OTP' });
    }
  } catch (error) {
